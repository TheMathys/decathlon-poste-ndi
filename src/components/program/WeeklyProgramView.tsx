...
export const WeeklyProgramView: React.FC<WeeklyProgramViewProps> = ({ program, onStartTrainingForDay }) => {
      ...
      <div className="space-y-6">
        {Array.from(exercisesByDay.entries())
          ...
          .map(([dayOfWeek, exercises]) => (
            <div key={dayOfWeek} className="bg-white rounded-xl shadow-lg p-6 border border-gray-200">
                  ...
                  <p className="text-sm text-gray-600">
                    ...
                    {Math.ceil(
                      exercises.reduce((total, ex) => {
                        ...
                        const exerciseTime = sets * (typeof reps === "string" ? parseInt(reps) || 30 : repsNum * timePerRep);
              ...
              {onStartTrainingForDay && (
                <div className="mt-4 pt-4 border-t border-gray-200">
                  ...
                  >
                    🏋️ Démarrer l'entraînement du {DAYS[dayOfWeek]}
                  </Button>
                </div>
              )}
            </div>
